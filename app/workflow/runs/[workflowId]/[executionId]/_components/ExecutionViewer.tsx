...
import { ExecutionLog } from "@/generated/prisma/client";
...
function ParameterViewer({
  ...
  return (
    <Card className="overflow-hidden pt-0">
      <CardHeader className="p-4! bg-gray-50 dark:bg-background border-b rounded-lg rounded-b-none">
...
function LogViewer({ logs }: { logs: ExecutionLog[] | undefined }) {
  ...
  return (
    <Card className="w-full pt-0">
      <CardHeader className="p-4! bg-gray-50 dark:bg-background border-b rounded-xl rounded-b-none">
            ...
            {logs.map((log) => (
              <TableRow key={log.id} className="text-muted-foreground">
                ...
                <TableCell
                  width={80}
                  className={cn(
                    "p-0.7 pl-4 font-bold text-xs uppercase",
